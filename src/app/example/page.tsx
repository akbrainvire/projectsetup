...
} from "@/components/selection/OptionSelectGroup/types";
import type { RootState } from "@/redux/store";
import { RATING_CONSTANTS } from "@/constants/rating";
import { SITE_COLORS, TRANSLATION_KEYS } from "@/utility/strings";
import { ExamplePageStyles } from "./styles";
...
export default function ExamplePage() {
  ...
  const [ratingValue, setRatingValue] = useState<number>(
    HOME_RATING_DEMOS.INITIAL_VALUE
  );

  const handleRatingChange = (nextValue: number) => {
    console.log("[Rating] onChange", { value: nextValue });
  ...
  return (
    <PageShell>
      <ExamplePageStyles.Main>
        <ExamplePageStyles.Stack>
          ...
          <ExamplePageStyles.ButtonSection>
            <Typography.Title level={4}>
              {t(TRANSLATION_KEYS.HOME.BUTTONS.TITLE)}
            </Typography.Title>
            <ExamplePageStyles.ButtonRow>
              <CustomButton
          ...
          <ExamplePageStyles.CardSection>
            ...
            <ExamplePageStyles.CountdownTimerRow>
              <CountdownTimer
                durationSeconds={
          ...
          <ExamplePageStyles.CardSection>
            <Typography.Title level={4}>
              {t(RATING_CONSTANTS.SHOWCASE.TITLE_KEY)}
            </Typography.Title>
            <ExamplePageStyles.RatingRow>
              <Rating
                value={ratingValue}
                max={HOME_RATING_DEMOS.MAX}
                size={HOME_RATING_DEMOS.SIZE}
                onChange={handleRatingChange}
                allowClear
              />
              <Rating
                value={HOME_RATING_DEMOS.READ_ONLY_VALUE}
                max={HOME_RATING_DEMOS.MAX}
                size={HOME_RATING_DEMOS.SIZE}
                label={t(RATING_CONSTANTS.SHOWCASE.READ_ONLY_KEY)}
                readOnly
              />
            </ExamplePageStyles.RatingRow>
            <Typography.Text type="secondary">
              {t(RATING_CONSTANTS.ARIA.VALUE_KEY, {
                value: ratingValue,
                max: HOME_RATING_DEMOS.MAX,
              })}
            </Typography.Text>
          ...
          <ExamplePageStyles.CardSection>
            ...
            <ExamplePageStyles.SelectableCardRow>
          ...
          <ExamplePageStyles.CardSection>
            ...
            <ExamplePageStyles.IconInfoCardRow>
              <IconInfoCard
          ...
          <ExamplePageStyles.CardSection>
            ...
            <ExamplePageStyles.DiscountCodeStack>
              <DiscountCodeInput
                value={discountCodeValue}
          ...
          <ExamplePageStyles.CardSection>
            ...
            <ExamplePageStyles.BookingShowcaseShell>
              <ExamplePageStyles.BookingShowcasePanel>
